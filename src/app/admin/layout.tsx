                    ...
                    >
                        ...
                        <nav className="flex flex-col gap-6 sm:gap-8 w-full max-w-sm">
                            <Link
                                ...
                                className="font-display text-3xl sm:text-5xl tracking-wide italic text-white hover:text-mystic-400 transition-all duration-300 transform hover:scale-105"
